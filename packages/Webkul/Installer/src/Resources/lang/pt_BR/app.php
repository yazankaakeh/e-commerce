    ...
    'installer' => [
        ...
        'index' => [
            ...
            'installation-processing' => [
                'bagisto' => 'Contrast',
                'contrast-info' => 'A criação de tabelas no banco de dados pode levar alguns momentos',
                'title' => 'Instalação',
            ],

            'installation-completed' => [
                'admin-panel' => 'Painel de Administração',
                'contrast-forums' => 'Fórum Contrast',
                'customer-panel' => 'Painel do Cliente',
                'explore-contrast-extensions' => 'Explorar Extensões Contrast',
                'title' => 'Instalação Concluída',
                'title-info' => 'O Contrast foi instalado com sucesso no seu sistema.',
            ],
            ...
            'installation-description' => 'A instalação do Contrast geralmente envolve várias etapas. Aqui está uma visão geral do processo de instalação do Contrast',
